...
let handler = async (m, { conn, args, text, usedPrefix: _p, command, isROwner }) => {
    ...
    //Manage panel
    const domain = "https://quinella.sobeks.online" // Domain
const apikey = "ptla_cDryJZA3SAG81c1EMOxqBbZoWMoYmRuEiaODPsFX45x" // Apikey
const c_apikey = "ptlc_kFzwjwxaSe4LGpuhp7K7oTimnmuT71Va31YNOxwV2pg" // c Apikey
